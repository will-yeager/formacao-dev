...
public class TesteEnvioNaoBloqueante {
	...
	public static void main(String[] args) {
		...
		publisher.consume(data -> {
			System.out.println("Outra thread do TesteEnvioBloqueante é: " + Thread.currentThread().getName());
		});
		publisher.consume(data -> {
			System.out.println("Mais uma thread do TesteEnvioBloqueante é: " + Thread.currentThread().getName());
		});
